...
public class oAuthSina : oAuthBase
{
    ...
    SinaBusiness.Config.SConfig sconifg= new SinaBusiness.Config.SConfig();
    ...
    public string appSecret
    {
        get
        {
            ...
            {
                _appSecret = "9e0fc7b629797f6b16145142ddc14b85"; 
            }
            return _appSecret;
        }
    ...
    public string token { get {
        if (sconifg.isAutoLogin())
        {
            return sconifg.UserName;
        }
        else
        {
            return _token; 
    ...
    #endregion
    public string _WebRequest(Method method, string url, string postData)
    {
    ...
    {
        string postData = "&source=" + appKey; 
        string response = oAuthWebRequest(Method.GET, REQUEST_TOKEN, postData);
    ...
    public void AccessTokenGet()
    {
        ...
        string response = oAuthWebRequest(Method.GET, ACCESS_TOKEN, postData);
    ...
    public string oAuthWebRequestWithPic(Method method, string url, string postData, string filepath)
    {
        ...
        GetPicHttpRequest(method, url, UploadApiUrl, out contentEncoding, out boundary, out request); 
    ...
    public void GetPicHttpRequest(Method method, string url, string UploadApiUrl, out string contentEncoding, out string boundary, out HttpWebRequest request)
    {
        ...
        request = (HttpWebRequest)System.Net.WebRequest.Create(UploadApiUrl);
